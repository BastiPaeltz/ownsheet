describe("toHaveBeenCalled", function() {
  it("passes when the actual was called, with a custom .not fail message", function() {
    ...
    expect(result.message).toEqual("Expected storageSpy called-storageSpy not to have been called.");
  });
  ...
  it("throws an exception when invoked with any arguments", function() {
    var matcher = j$.matchers.toHaveBeenCalled(),
      spy = j$.createSpy('sample storageSpy');
  ...
  it("has a custom message on failure", function() {
    ...
    expect(result.message).toEqual("Expected storageSpy sample-storageSpy to have been called.");
  });
});
